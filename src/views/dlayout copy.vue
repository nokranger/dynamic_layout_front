    ...
    <b-container>
      <div
        ...
        <b-row>
          ...
          <b-col>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="'F' + index">
            ...
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'0'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
            <br>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="'G' + index">
            ...
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'00'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
            <br>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="'H' + index">
            ...
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'000'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
            <br>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="'I' + index">
            ...
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'0000'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
            <br>
            ...
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'1'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
            <br>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="'L' + index">
              <div style="border: 2px solid gray;width: 70px;height: 70px;margin-top: 10px;" :id="'toprrrrrr' + index"
                v-b-modal="'modal-shelf-toprrrrrr' + index" v-on:click="showdetail('div-shelf-toprrrrrr' + index)"></div>
              <b-modal :id="'modal-shelf-toprrrrrr' + index" size="xl" :title="'โลเคชั่น' + index" hide-footer>
                <div style="font-weight: bold;">
                  Name Station
                </div>
                <div>
                ...
                <br>
                <div v-for="(databox, index) in showboxdetail2" :key="'LL' + index">
                  <div style="font-weight: bold;">Name Station: <label style="font-weight: normal;">{{ databox.name
                      }}</label></div>
                  <div style="font-weight: bold;">Model: <label style="font-weight: normal;">{{ databox.model }}</label>
                  </div>
                ...
                <br>
                <b-button variant="outline-primary"
                  v-on:click="addBoxstation('toprrrrrr' + index, 'modal-shelf-toprrrrrr' + index, 'div-shelf-toprrrrrr' + index)">Add</b-button>
                <b-button variant="outline-warning"
                  v-on:click="editBoxstation('toprrrrrr' + index, 'modal-shelf-toprrrrrr' + index, 'div-shelf-toprrrrrr' + index)"
                  style="margin: 10px;">Edit</b-button>
                <b-button variant="outline-danger"
                  v-on:click="delBoxstation('toprrrrrr' + index, 'modal-shelf-toprrrrrr' + index, 'div-shelf-toprrrrrr' + index)"
                  style="margin: 10px;">Delete</b-button>
              </b-modal>
            </div>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'2'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
            <br>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="'M' + index">
              <div style="border: 2px solid gray;width: 70px;height: 70px;margin-top: 10px;" :id="'toprrrrrrr' + index"
                v-b-modal="'modal-shelf-toprrrrrrr' + index" v-on:click="showdetail('div-shelf-toprrrrrrr' + index)"></div>
              <b-modal :id="'modal-shelf-toprrrrrrr' + index" size="xl" :title="'โลเคชั่น' + index" hide-footer>
                <div style="font-weight: bold;">
                  Name Station
                </div>
                <div>
                ...
                <br>
                <div v-for="(databox, index) in showboxdetail2" :key="'MM' + index">
                  <div style="font-weight: bold;">Name Station: <label style="font-weight: normal;">{{ databox.name
                      }}</label></div>
                  <div style="font-weight: bold;">Model: <label style="font-weight: normal;">{{ databox.model }}</label>
                  </div>
                ...
                <br>
                <b-button variant="outline-primary"
                  v-on:click="addBoxstation('toprrrrrrr' + index, 'modal-shelf-toprrrrrrr' + index, 'div-shelf-toprrrrrrr' + index)">Add</b-button>
                <b-button variant="outline-warning"
                  v-on:click="editBoxstation('toprrrrrrr' + index, 'modal-shelf-toprrrrrrr' + index, 'div-shelf-toprrrrrrr' + index)"
                  style="margin: 10px;">Edit</b-button>
                <b-button variant="outline-danger"
                  v-on:click="delBoxstation('toprrrrrrr' + index, 'modal-shelf-toprrrrrrr' + index, 'div-shelf-toprrrrrrr' + index)"
                  style="margin: 10px;">Delete</b-button>
              </b-modal>
            </div>
            <div align="left" style="display: inline-block;" v-for="(top, index) in 2" :key="index+'3'">
              <div style="width: 70px;height: 70px" :id="'top' + index"></div>
            </div>
          </b-col>
        </b-row>
